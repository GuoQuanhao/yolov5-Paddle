...
class ConfusionMatrix:
    ...
    def process_batch(self, detections, labels):
        ...
        gt_classes = labels[:, 0].astype(np.int)
        detection_classes = detections[:, 5].astype(np.int)
...
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    ...
    # https://github.com/PaddlePaddle/PaddleDetection/blob/release/2.2/ppdet/modeling/bbox_utils.py
    box2 = box2.T
    ...
    if GIoU or DIoU or CIoU:
        cw = paddle.maximum(b1_x2, b2_x2) - paddle.minimum(b1_x1, b2_x1)  # convex (smallest enclosing box) width
